                      ...
                      >
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
                          <span className="text-xs text-zinc-500">
                            Trạng thái cấp Key: <strong className="text-zinc-800">{isPaid ? "Đã gửi qua Email & Hệ thống" : "Chờ xác thực thanh toán"}</strong>
                          </span>
                          {isPaid && (
                            <button
                              type="button"
                          ...
                          <div className="mt-3 p-4 bg-zinc-900 text-white rounded-2xl space-y-3 ring-1 ring-black/20">
                            ...
                            {keysQuery.isLoading ? (
                              ...
                              <p className="text-xs text-zinc-400 italic">
                                Mã key bản quyền đã được gửi tự động qua Gmail đăng ký của bạn. Nếu cần hỗ trợ nhanh, vui lòng gọi Hotline 0383 158 080.
                              </p>
                            )}
                          </div>
                        )}
