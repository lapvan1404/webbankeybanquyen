      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {/* Thông báo xác nhận thanh toán trực tiếp trên Website */}
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-4 flex items-center gap-3.5">
              ...
              <div className="text-xs text-emerald-900">
                <p className="font-bold text-sm">Admin đã xác nhận thanh toán thành công!</p>
                <p className="text-emerald-700 mt-0.5">
                  Mã Key bản quyền của bạn đã sẵn sàng và được hiển thị trực tiếp bên dưới.
                </p>
              </div>
            </div>
